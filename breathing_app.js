...
function createProgressIndicator() {
    ...
    */
    ...
    progressTitle.style.cssText = 'margin: 0 0 8px 0; color: white; font-size: 14px;';
    ...
    cycleCounter.style.cssText = 'color: white; font size: 12px; margin-bottom:5px;';
    ...
    currentPhase.style.cssText = 'color: white; font size: 12px;';
...
function updateDisplay() {
    ...
    */
    circle.classList.remove('breathe-in', 'breath-out');
